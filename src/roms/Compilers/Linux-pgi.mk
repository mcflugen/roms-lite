# svn $Id: Linux-pgi.mk 2328 2014-01-23 20:16:18Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
#jmm
    NETCDF_INCDIR ?= /usr/vimssw/pgi-8.0-linux86-64/netcdf/3.6.2/include
    NETCDF_LIBDIR ?= /usr/vimssw/pgi-8.0-linux86-64/netcdf/3.6.2/lib
...
#           FFLAGS += -g -C
           FFLAGS += -g -C -tp k8-64 -mcmodel=medium
#          FFLAGS += -gopt -C
#          FFLAGS += -g
else
#          FFLAGS += -Bstatic -fastsse -Mipa=fast
#           FFLAGS += -O3
           FFLAGS += -fastsse -Mipa=fast -tp k8-64 -mcmodel=medium
endif
...
ifdef USE_MCT
#jmm
       MCT_INCDIR ?= /export/home/moriarty/MCT/MCT/include
       MCT_LIBDIR ?= /export/home/moriarty/MCT/MCT/lib
