...
!
!! svn $Id: ana_sediment.h 2328 2014-01-23 20:16:18Z arango $
!!======================================================================
...
!
          DO k=1,Nbed
            bed(i,j,k,iaged)=time(ng)
            bed(i,j,k,ithck)=0.20_r8    ! 10 cm thick layer
            bed(i,j,k,iporo)=0.70_r8    ! 90% porosity
!jmm 5/30/2011 -- get rid of initial sed deposit
            bed_frac(i,j,k,NST)=1.0_r8
            DO ised=1,NST-1
